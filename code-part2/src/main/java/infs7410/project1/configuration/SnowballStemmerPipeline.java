...
public class SnowballStemmerPipeline extends TextProcessingPipeline {

    public SnowballStemmerPipeline() {
        super("snowball");
    }
    ...
    public void Configure() {
        ...
        ApplicationSetup.setProperty("querying.default.controls", "terrierql:on," +
                ...
                "filters:on," +
                "decorate:on");
        ApplicationSetup.setProperty("termpipelines", "EnglishSnowballStemmer");
    }
}
